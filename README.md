...
__This is a modified fork of [https://github.com/auctifera-josed/starprnt](https://github.com/auctifera-josed/starprnt)__
...
Cordova: `cordova plugin add cordova-plugin-ia-starprnt`

**Warning:** when updating you should run first `ionic cordova plugin rm cordova-plugin-ia-starprnt` and then install again
